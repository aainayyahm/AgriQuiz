...
struct QPostHarvest: View {
    let question = [
        Question2(text: "The process of mass transfer of water or other solvents from a solid or semi-solid substance by means of evaporation is called?", options: ["Heating", "Drying", "Freezing"], correctAnswer: 1),
    ]
...
struct QPostHarvest_Previews: PreviewProvider {
